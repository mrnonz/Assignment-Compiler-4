...
{
       0,    53,    53,    56,    57,    60,    61,    62,    66,    67,
      74,    80,    86,    87,    88,    92,    99,   105,   115,   116,
     129
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LOOP", "DEC", "HEX", "EXIT", "STR", "ENDOFFILE", "'='", "'-'", "'+'",
  "'*'", "'/'", "NEG", "'^'", "'{'", "'\\n'", "'}'", "';'", "'%'", "'('",
  "')'", "$accept", "file", "input", "line", "exp", "val", "command",
  "show", YY_NULLPTR
};
#endif
...
{
     -16,   -12,    12,    -3,   -17,     0,   -11,   -17,   -17,   -17,
      -1,    -7,    -3,    21,   -17,    -6,   -17,    -1,    14,   -17,
      17,   -17,   -17,    -1,    -1,    -1,    -1,   -17,    -1,   -17,
      32,    -5,   -17,   -14,   -14,    -4,    -4,    32,   -17
};
...
{
       0,     0,     0,     4,     1,    17,     0,    15,    16,     5,
       0,     0,     4,     0,     8,     0,    18,     0,     0,    17,
       0,     2,     3,     0,     0,     0,     0,     6,     0,     7,
      19,     0,    14,    10,     9,    11,    12,    13,    20
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -17,   -17,    18,   -17,     3,   -17,   -17,   -17
};
...
{
       5,     6,    19,    25,    26,     1,     7,     8,     7,     8,
       3,    28,     4,    20,    17,    18,    21,    31,    29,     9,
      30,    28,    38,    10,     0,    10,    33,    34,    35,    36,
      22,    37,    23,    24,    25,    26,    23,    24,    25,    26,
       0,     0,    28,     0,    32,    27,    28,    23,    24,    25,
      26,     0,     0,     0,     0,     0,     0,    28
};

static const yytype_int8 yycheck[] =
{
       3,     4,     3,    17,    18,    21,     9,    10,     9,    10,
      22,    25,     0,    10,    14,    26,    23,     3,    24,    22,
      17,    25,    27,    26,    -1,    26,    23,    24,    25,    26,
      12,    28,    15,    16,    17,    18,    15,    16,    17,    18,
      -1,    -1,    25,    -1,    27,    24,    25,    15,    16,    17,
      18,    -1,    -1,    -1,    -1,    -1,    -1,    25
};
...
{
       0,    21,    29,    22,     0,     3,     4,     9,    10,    22,
      26,    30,    31,    32,    33,    34,    35,    14,    26,     3,
      32,    23,    30,    15,    16,    17,    18,    24,    25,    24,
      32,     3,    27,    32,    32,    32,    32,    32,    27
};
